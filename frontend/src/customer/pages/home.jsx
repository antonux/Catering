		...
		<div className="home flex flex-col items-center pb-32">
			...
			<div className="flex items-center gap-28 justify-center mt-14">
				...
				<div className="flex flex-col items-center">
					<h1 className="text-center text-5xl leading-[3.5rem] lg:text-6xl 
					font-jomolhari font-normal lg:leading-[5.5rem] text-[#26110d]">CUISINE<br />CRAFTED<br />WITH CARE</h1>
					...
					<div className="font-roboto flex mt-4 w-full text-sm gap-3 flex-col lg:w-auto lg:text-base lg:flex-row lg:gap-5 text-nowrap lg:mt-8">
						<button class="px-14 py-2 bg-gradient-to-r from-[#4a4745] to-[#a08c63] text-[#f2f1ed] font-medium hover:border-[#c7b391] rounded-lg shadow-lg hover:shadow-xl hover:scale-105 transition-transform duration-300">
							Request Now
						</button>
						<button class="px-14 py-2 border-2 border-[#a08c63] text-[#4a4745] bg-transparent rounded-lg shadow-lg hover:bg-[#a08c63] hover:text-[#f2f1ed] hover:shadow-xl hover:scale-105 transition-transform duration-300">
							Contact Us
						</button>
					</div>
				</div>
				...
				<div className="flex flex-col">
					<div className="ml-[1.5rem] flex flex-col mt-3 gap-14">
						<div className="vision">
							...
							font-jomolhari font-normal text-[#4a4745]"><span className='text-[#c7a456]'>M</span>ission</h1>
						...
						<div className="vision">
							<h1 className="text-4xl lg:text-5xl 
							font-jomolhari font-normal text-[#4a4745]"><span className='text-[#c7a456]'>V</span>ission</h1>
			...
			{/* Our Menu */}
			<div className="relative home-menu text-lg flex flex-col items-center justify-center mt-32 w-[65rem] bg-[#c9b99f] p-10 py-16 rounded-lg">
				<h1 className="relative pl-1 text-4xl translate-y-[-29px] lg:text-[3.3rem] 
				font-jomolhari text-[#39221c] z-10 ">Menu</h1>
				<div className="absolute top-0 translate-y-14 left-0 bg-gradient-to-r from-[#e9e9e9] to-[#39221c] h-[2px] w-[40%]"></div>
				<div className="absolute top-0 translate-y-14 right-0 bg-gradient-to-l from-[#e9e9e9] to-[#39221c] h-[2px] w-[40%]"></div>
				...
				<div className="font-roboto mt-4 gap-16 text-center flex w-full justify-center">
					<div className="relative w-[16rem] h-full bg-[#fffff9] flex flex-col justify-center shadow-lg items-center rounded-[2.5rem]">
						...
						<p className='relative text-[#39221c] mt-7 font-ephesis text-4xl bg-[#fffff9] w-24 text-center z-40'>Soup</p>
						...
						<button class="bottom-0 absolute text-base translate-y-[-9px] px-14 py-[0.4rem] bg-[#4a4745] text-[#f2f1ed] font-medium hover:border-[#c7b391] rounded-3xl shadow-md hover:shadow-xl hover:scale-105 transition-transform duration-300">
							View
						</button>
					</div>
					...
					<div className="relative w-[16rem] h-full bg-[#fffff9] flex flex-col justify-center shadow-lg items-center rounded-[2.5rem]">
						...
						<p className='relative text-[#39221c] mt-7 font-ephesis text-4xl bg-[#fffff9] w-48 text-center z-40'>Main Entree</p>
					...
					<div className="relative w-[16rem] h-full bg-[#fffff9] flex flex-col justify-center shadow-lg items-center rounded-[2.5rem]">
						...
						<p className='relative mt-7 text-[#39221c] font-ephesis text-4xl bg-[#fffff9] w-32 text-center z-40'>Dessert</p>
						<div className="absolute bg-black h-[1px] w-full translate-y-3"></div>
						<div className="px-7 py-5 h-[15rem] flex">
